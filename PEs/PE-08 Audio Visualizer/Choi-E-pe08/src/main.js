...
function setupUI(canvasElement){
  ...
  let showGradientCheckbox = document.querySelector("#gradientCB");
  // add .onchange event to checkbox
  showGradientCheckbox.onchange = e => {
    drawParams.showGradient = e.target.checked;
  }
  // F - hookup showBars checkbox
  let showBarsCheckbox = document.querySelector("#barsCB");
  // add .onchange event to checkbox
  ...
  let showCirclesCheckbox = document.querySelector("#circlesCB");
  // add .onchange event to checkbox
  ...
  let showNoiseCheckbox = document.querySelector("#noiseCB");
  // add .onchange event to checkbox
  ...
  let showInvertCheckbox = document.querySelector("#invertCB");
  // add .onchange event to checkbox
  ...
  let showEmbossCheckbox = document.querySelector("#embossCB");
  // add .onchange event to checkbox
